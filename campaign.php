...
<div class="main">
    <h3 class="modal-title" style="text-align: center;font-weight: bolder;color: #A82128">Campaign Management</h3><br>
    ...
    <table class="table table-hover table-bordered display"style="max-width: 100%">
        ...
        while ($row = mysqli_fetch_row($result)) {
            ...
            echo "<td>$row[4]</td>";
            echo "<td>$row[5]</td>";
            echo "<td><a type='button' href='edit-Product.php?id=$row[0]' class='btn btn-info'><i class='glyphicon glyphicon-pencil' style='color: wheat' ></i></a>";
            echo "<a type='button' href='delete-Product.php?id=$row[0]' onlick='return confirm(\"Are u sure?\")' class='btn btn-danger'> <i class='glyphicon glyphicon-trash' style='color: wheat' ></i></a></td>";
            echo "</tr>";
        }
        ?>
        </tbody>
